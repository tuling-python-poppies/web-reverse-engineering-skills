...
def cookie_header_to_dict(cookie_header):
    ...
    for part in (cookie_header or '').split(';'):
        ...
        if key:
            cookies[key] = value
    return cookies
environment = {'location': {'ancestorOrigins': {}, 'href': 'http://chongqing.chinatax.gov.cn:8888/qxzfgs/wz/xzcf/swxzybcxcfjg', 'origin': 'http://chongqing.chinatax.gov.cn:8888', 'protocol': 'http:', 'host': 'chongqing.chinatax.gov.cn:8888', 'hostname': 'chongqing.chinatax.gov.cn', 'port': '8888', 'pathname': '/qxzfgs/wz/xzcf/swxzybcxcfjg', 'search': '', 'hash': ''}, 'navigator': {'userAgent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36'}}
url = 'http://chongqing.chinatax.gov.cn:8888/api/loadNewsInfo'
data = {'twolm': 'swxzybcxcfjg', 'siteCode': 'wz', 'rows': '15', 'input1': '123', 'checkVerifyCode': '5905'}
headers = {'Accept': 'application/json, text/javascript, */*; q=0.01', 'Accept-Language': 'zh-CN,zh;q=0.9,en;q=0.8', 'Cache-Control': 'no-cache', 'Connection': 'keep-alive', 'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8', 'Origin': 'http://chongqing.chinatax.gov.cn:8888', 'Pragma': 'no-cache', 'Referer': 'http://chongqing.chinatax.gov.cn:8888/qxzfgs/wz/xzcf/swxzybcxcfjg', 'User-Agent': environment['navigator']['userAgent'], 'X-Requested-With': 'XMLHttpRequest'}
