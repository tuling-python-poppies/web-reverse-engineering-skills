...
#   references/case-live-reference-archive/iv8/geetest-v4-slider/entry.py
...
def _reject_case_live_egress(action: str = "live HTTP") -> None:
    raise RuntimeError(
        ...
        f"Historical code: references/case-live-reference-archive/iv8/geetest-v4-slider/entry.py. "
