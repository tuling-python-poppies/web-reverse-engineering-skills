...
#   references/case-live-reference-archive/iv8/ouyeel-202-cookie-url/entry.py
...
CASE_ID = 'iv8-ouyeel-202-cookie-url'
...
def _reject_case_live_egress(action: str = "live HTTP") -> None:
    raise RuntimeError(
        ...
        f"Historical code: references/case-live-reference-archive/iv8/ouyeel-202-cookie-url/entry.py. "
