...
#   references/case-live-reference-archive/iv8/tencent-tdc-slider/entry.py
...
CASE_ID = 'iv8-tencent-tdc-slider'
...
def _reject_case_live_egress(action: str = "live HTTP") -> None:
    raise RuntimeError(
        ...
        f"Historical code: references/case-live-reference-archive/iv8/tencent-tdc-slider/entry.py. "
