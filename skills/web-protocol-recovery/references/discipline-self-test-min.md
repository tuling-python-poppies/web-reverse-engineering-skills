...
| D11 | Historical case entry import | `python -c "import importlib.util; ..."` / import of entry must not open network, mkdir, or start iv8; alias/from-import requests and unguarded `main()` must be caught |
