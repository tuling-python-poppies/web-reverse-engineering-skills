...
3. reconnaissance, AST, env-patch, iv8, akamai, verifier, douyin-abogus-native, and sample artifacts stay in their assigned `js_reverse_cache/**` or `tests/**` paths until accepted;
