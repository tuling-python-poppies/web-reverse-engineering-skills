/**
  * @env-module observer-constructors
...
(function() {
    ...
    console.log('[observer-constructors.js] 观察者API加载完成：MutationObserver, IntersectionObserver, ResizeObserver, PerformanceObserver, ReportingObserver');
