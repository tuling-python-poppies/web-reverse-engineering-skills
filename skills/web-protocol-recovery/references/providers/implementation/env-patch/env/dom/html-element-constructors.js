/**
  * @env-module html-element-constructors
...
(function() {
    ...
    if (!Element) {
        console.error('[html-element-constructors.js] Element class not found, please load document-dom-runtime.js first');
        return;
    }
    ...
    console.log('[html-element-constructors.js] HTML元素类型库加载完成，共注册', Object.keys(elementConstructors).length, '种元素类型');
