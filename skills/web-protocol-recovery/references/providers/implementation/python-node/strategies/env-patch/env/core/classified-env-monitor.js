/**
  * @env-module classified-env-monitor
 ...
 * @conflict 与 core/element-mock-monitor.js 互斥（二者均注册 window.__EnvMonitor__），不要同时加载。与 core/proxy-access-monitor.js 不建议混用（功能重叠）。
 * @alternatives core/proxy-access-monitor.js（首选，所有模块的基础依赖）、core/element-mock-monitor.js（侧重元素代理 + 属性监控 + mock 钩子）
 * @version 2.0.0
